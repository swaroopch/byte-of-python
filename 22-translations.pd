...
If you plan to start a new translation, please read the [Translation Howto](#translation-howto).

## Arabic
 
Below is the link for the Arabic version. Thanks to Ashraf Ali Khalaf for translating the book, you can read the whole book online [here](http://www.khaledhosny.org/byte-of-python/index.html) or you can download it 
from [sourceforge.net](http://downloads.sourceforge.net/omlx/byteofpython_arabic.pdf?use_mirror=osdn)
...
[Samuel Dias Neto](http://www.samueldiasneto.com/aprendendopython/index.html) (samuel.arataca-at-gmail-dot-com) made the first Brazilian Portuguese translation of this book when Python was in 2.3.5 version.

Samuel's translation is available at [aprendendopython](http://www.samueldiasneto.com/aprendendopython/index.html).

[Rodrigo Amaral](http://rodrigoamaral.net) (rodrigoamaral-at-gmail-dot-com) has volunteered to translate the book to Brazilian Portuguese. 

Rodrigo's translation is available at [http://www.swaroopch.org/notes/Python_pt-br:Indice](http://www.swaroopch.org/notes/Python_pt-br:Indice).

## Catalan

Moises Gomez (moisesgomezgiron-at-gmail-dot-com) has volunteered to translate the book to Catalan.
The translation is in progress, and was present in the [erstwhile wiki](http://www.swaroopch.com/notes/).
...
Here's a Chinese version at [http://www.swaroopch.org/notes/Python_cn:Table_of_Contents](http://www.swaroopch.org/notes/Python_cn:Table_of_Contents).

Juan Shen (orion-underscore-val-at-163-dot-com) has volunteered to translate the book to Chinese.
It is available at [http://www.pycn.org/python%E5%9C%A8%E7%BA%BF%E6%89%8B%E5%86%8C](http://www.pycn.org/python%E5%9C%A8%E7%BA%BF%E6%89%8B%E5%86%8C).
...
Gérard Labadie (Palmipede) has completed to translate the book to French, it starts with [http://www.swaroopch.org/notes/Python_fr:Table_des_Mati%C3%A8res](http://www.swaroopch.org/notes/Python_fr:Table_des_Mati%C3%A8res).
...
Their translation is located at [http://abop-german.berlios.de](http://abop-german.berlios.de).
...
Daniel (daniel-dot-mirror-at-gmail-dot-com) is translating the book to Indonesian at [http://python.or.id/moin.cgi/ByteofPython](http://python.or.id/moin.cgi/ByteofPython).

W. Priyambodo also has volunteered to translate the book to Indonesian. The translation is in progress and here is the [http://www.swaroopch.org/notes/Python_id:Daftar_Isi](http://www.swaroopch.org/notes/Python_id:Daftar_Isi).
...
The Italian translation is present at [www.gentoo.it/Programmazione/byteofpython](http://www.gentoo.it/Programmazione/byteofpython). The new translation is in progress and start with [http://www.swaroopch.org/notes/Python_it:Prefazione](http://www.swaroopch.org/notes/Python_it:Prefazione).
...
Here's a Japanese version at [http://www.swaroopch.org/notes/Python_ja:Table_of_Contents](http://www.swaroopch.org/notes/Python_ja:Table_of_Contents).
...
Eirik Vågeskar ([http://www.swaroopch.org/notes/User:Vages](http://www.swaroopch.org/notes/User:Vages)) is a high school student at [Sandvika videregående skole](http://no.wikipedia.org/wiki/Sandvika_videreg%C3%A5ende_skole) in Norway, a [blogger](http://forbedre.blogspot.com/) and currently translating the book to Norwegian (bokmål). The translation is in progress, and you can check the [http://www.swaroopch.org/notes/Python_nb-no:Innholdsfortegnelse](http://www.swaroopch.org/notes/Python_nb-no:Innholdsfortegnelse) for more details.
...
Dominik Kozaczko (dkozaczko-at-gmail-dot-com) has volunteered to translate the book to Polish. Translation is in progress and it's main page is available here: [Ukąś Pythona](http://wiki.lo5.bielsko.pl/index.php/Uk%C4%85%C5%9B_Pythona).
...
The translation is being done [http://www.swaroopch.org/notes/Python_ro](http://www.swaroopch.org/notes/Python_ro).
...
Vladimir Smolyar (v_2e-at-ukr-dot-net) has started a Russian translation wiki pages. You may read the development version at [http://www.swaroopch.org/notes/Python_ru:Table_of_Contents](http://www.swaroopch.org/notes/Python_ru:Table_of_Contents).

## Slovak

Albertio Ward (albertioward-at-gmail-dot-com) has translated the book to Slovak at [fatcow.com/edu/python-swaroopch-sl/](http://www.fatcow.com/edu/python-swaroopch-sl/) :
...
Alfonso de la Guarda Reyes (alfonsodg-at-ictechperu-dot-net), Gustavo Echeverria (gustavo-dot-echeverria-at-gmail-dot-com), David Crespo Arroyo (davidcrespoarroyo-at-hotmail-dot-com) and Cristian Bermudez Serna (crisbermud-at-hotmail-dot-com) have volunteered to translate the book to Spanish. The translation is in progress, you can read the spanish (argentinian) translation starting by the [http://www.swaroopch.org/notes/Python_es-ar:Tabla_de_Contenidos](http://www.swaroopch.org/notes/Python_es-ar:Tabla_de_Contenidos).
...
> I am student of Telecommunications engineering at the University of Antioquia (Colombia). Months ago, i started to learn Python and found this wonderful book, so i volunteered to get the Spanish translation.  </blockquote>
